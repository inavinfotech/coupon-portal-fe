...
import { Ticket, Lock, Mail, ArrowRight, ShieldCheck, Loader2 } from 'lucide-react';
      ...
      <div className="w-full max-w-md relative">
        <div className="bg-white border border-gray-200 rounded-2xl shadow-xl overflow-hidden p-8 sm:p-10 text-center">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Coupon Dashboard</h1>
            <p className="text-gray-500 mt-1 text-sm font-medium">Discount System Control Portal</p>
          </div>
